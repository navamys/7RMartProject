...
public class ManageProductPage {
	...
	@FindBy(xpath = "//input[@name='featured' and @value='yes']")
	private WebElement featuredradio;
	@FindBy(xpath = "//button[@type='submit']")
	private WebElement savebutton;
	@FindBy(xpath = "//input[@id='m_weight']")
	private WebElement weightvaluefield;
	@FindBy(xpath = "//select[@id='w_unit']")
	private WebElement weightunitdropdown;
	@FindBy(xpath = "//input[@id='max_weight']")
	private WebElement maxquantityfield;
	...
	public ManageProductPage fileUpload() throws AWTException {
		...
		// fileuploadutilities.FileuploadUsingRobotclass(uploadimagebutton,
		// Constants.APPLE_IMAGE);
