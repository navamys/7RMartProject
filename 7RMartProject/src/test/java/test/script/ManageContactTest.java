...
public class ManageContactTest extends Base {
	...
	public void VerifyIfUserIsAbleToUpdateContact() throws IOException {
		...
		managecontactpage.clickOnUpdateicon().enterPhonenumber(phonenumber).enterEmail(email).enterAddress(address).enterDeliveryTime(deliverytime).enterDeliveryCharge(deliverycharge).clickOnUpdatebutton();
