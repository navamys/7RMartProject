...
public class AdminuserTest extends Base{
	...
	public void verifyIfUserIsAbleToUpdateAllFields() throws IOException {
		...
		adminuserpage.clickOnUpdateIcon().enterValueToBeUpdatedOnUsernameField(usernameupdatevalue).enterValueToBeUpdatedOnPasswordField(passwordupdatevalue).selectValueOnUsertypeField().clickOnUpdateButton();
		...
		adminuserpage.clickOnUpdateButton();*/  //wrote in single line aabove
